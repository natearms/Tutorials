    ...
    class Program
    {
        static void Main(string[] args)
        {
            List<Car> myCars = new List<Car>()
            {
                ...
                new Car() {VIN ="B2", Make = "Toytoa", Model = "4RUnner", StickerPrice = 35000, Year = 2001},
                new Car() {VIN ="C3", Make = "BMW", Model = "745li", StickerPrice = 75000, Year = 2003},
                new Car() {VIN ="D4", Make = "Ford", Model = "Escape", StickerPrice = 25000, Year = 2018},
            ...
            */
            ...
            //var bmws = myCars.Where(p => p.Make == "BMW" && p.Year == 2005);
